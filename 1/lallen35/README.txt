...
I used Weka 3.8.0 through the GUI. I included my experiment file for krkopt in data/krkopt.exp, my dataset in data/krkopt.arff, and the results data used for analysis of my experiments in krkopt results/krkopt-{30,50,70}-split.arff.

I included my experiment file for letters in data/letters.exp, my dataset in data/letter.arff, and the results data used for analysis of my experiments in LIR_results/letters-{30,50,70}-split.arff.

Below are the READMEs included in my two dataset, which I found at the UCI website:
